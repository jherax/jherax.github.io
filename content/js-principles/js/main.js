(function($, undefined) {
	...
	var steps = {
        ...
        "#strategy-2": {
            x: 1400, y: -2300, z: -800, rotate: { x: 270, y: 180 }
        },
        "#awsome": {
            x: 1100, y: 1390, z: -580, scale: 2
        },
        "#questions": {
            x: 1800, y: 1400, scale: 3, rotate: { y: 90, z: -90 }
        },
        "#thank-you": {
            x: 2700, y: 1300, scale: 3, z: 440
        }
    };
    ...
    var i = 1, total = $("div.step").length - 4;
